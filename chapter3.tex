...
%The problems of metadata based image retrieval and rapid growth in the quantity and availability of digital images motivates research into automatic image retrieval
...
%		\includegraphics[width=0.7\linewidth]{chapter1/figures/fig1}
	...
	%	\includegraphics[width=0.7\linewidth]{chapter1/figures/fig2}
		...
		\label{fig:fig2}
	\end{figure}
% the ternary patterns are split in to upper and lower patterns by substituting ‘1’ for ‘+1’ to get upper binary pattern and ‘1’ for ‘-1’ for lower binary pattern in both the cases ‘0’ for ‘0’’s
